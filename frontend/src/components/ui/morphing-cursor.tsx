...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
    ...
    return (
        ...
        >
            ...
            <span className="text-6xl md:text-9xl font-black italic tracking-tighter uppercase leading-none text-white">{text}</span>
            ...
            >
                ...
                >
                    <span className="text-6xl md:text-9xl font-black italic tracking-tighter uppercase leading-none text-black whitespace-nowrap">
                        {hoverText}
                    </span>
                </div>
            </div>
