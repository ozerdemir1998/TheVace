...
export const FullScreenScrollFX = forwardRef<HTMLDivElement, FullScreenFXProps>(
    (
        ...
        const splitWords = (text: string | ReactNode) => {
        ...
        return (
          ...
          .fx-fixed-section { height: 100vh; position: relative; overflow: hidden; }
          .fx-fixed { position: relative; height: 100vh; width: 100%; overflow: hidden; background: var(--fx-page-bg); }
          ...
          .fx-left-item.active, .fx-right-item.active { opacity: 1; color: #fff; text-shadow: 0 0 20px rgba(255,255,255,0.4); }
          ...
          .fx-featured-content { display: flex; flex-col; items: center; gap: 2rem; }
          .fx-featured-title {
